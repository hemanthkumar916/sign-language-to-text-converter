...
@tf.keras.utils.register_keras_serializable(package="Uplift")
class LogLossMeanBaseline(tf.keras.metrics.Metric):
  ...
  def __init__(
    ...
    if slice_by_treatment:
      ...
      self._mean_label = tf.keras.metrics.Mean(name=name, dtype=dtype)
...
@tf.keras.utils.register_keras_serializable(package="Uplift")
class LogLossMinimum(tf.keras.metrics.Metric):
  ...
  def __init__(
    ...
    if slice_by_treatment:
      ...
      self._loss = tf.keras.metrics.Mean(name=name, dtype=dtype)
...
@tf.keras.utils.register_keras_serializable(package="Uplift")
class PseudoRSquared(tf.keras.metrics.Metric):
