...
class MultiScaleMaskConverModel(tf.keras.Model):
  """Multiscale MaskConver class model."""

  def __init__(self,
               backbone: tf.keras.Model,
               decoder: tf.keras.Model,
               mask_decoder: tf.keras.Model,
               class_head: tf.keras.layers.Layer,
               embedding_head: tf.keras.layers.Layer,
               per_pixel_embeddings_head: tf.keras.layers.Layer,
               mlp_embedding_head: tf.keras.layers.Layer,
               panoptic_generator: Optional[tf.keras.layers.Layer] = None,
               min_level: int = 3,
               max_level: int = 5,
    ...
    self.class_embeddings = tf.keras.layers.Embedding(
        num_classes,
        self.embedding_size,
